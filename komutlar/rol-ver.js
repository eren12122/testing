...
exports.run = (client, message, args) => {
  ...
  if (message.mentions.users.size < 1) return message.channel.send('❎ | Bu komutun kullanımı şu şekildedir > **pop!rol-ver @kullanıcı <rolün adı>**').catch(console.error);
  ...
  const embed = new Discord.RichEmbed()
    .setColor(0x00AE86)
    .setTimestamp()
    .addField('Eylem:', 'Birine Rol verildi')
    .addField('Rol:', `${yetki}`)
